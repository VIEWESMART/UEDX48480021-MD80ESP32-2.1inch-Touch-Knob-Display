...
//2.1带触摸
    ...
    {0xEB, {0x00,0x00,0x40,0x40,0x00,0x00,0x00}, 1},
...
static esp_err_t lcd_config(void)
{
    ...
    // vTaskDelay(pdMS_TO_TICKS(120));
    // BSP_ERROR_CHECK_RETURN_ERR(spi_write_cmd(0x3A));
    // BSP_ERROR_CHECK_RETURN_ERR(spi_write_data(0x66));
    // BSP_ERROR_CHECK_RETURN_ERR(spi_write_cmd(0x36));
    // BSP_ERROR_CHECK_RETURN_ERR(spi_write_data(0x00));
    // BSP_ERROR_CHECK_RETURN_ERR(spi_write_cmd(0x35));
    // BSP_ERROR_CHECK_RETURN_ERR(spi_write_data(0x00));
